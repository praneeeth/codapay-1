      ...
      for (const driverObj  of listDriver) {
        try{
          ...
          let loginInfo= await axios({
              url: `https://app.yellowmessenger.com/api/sso/v2login`, 
              method: 'POST',
              headers: {'x-auth-token': authToken},
              data:{"username":driverObj.email,"password":"ab9350795f93610259f54f61712c26b4","type":"account","referrer":"web"}
          })
         
          let accessToken=loginInfo.data.access_token;
  
          const options = {
              url: `https://app.yellowmessenger.com/api/sso/invite/accept`, 
              method: 'POST',
         ...
         // await sleep(200)
          ...
          failedDrivers.push(driverObj)
         
        }
      
      }
      console.log("==== FAILED DRIVERS ====")
      console.log(failedDrivers)
